...
public class OrderPageController {
    ...
    public String placeOrder(
        ...
        Order order = orderService.placeOrder(customerInfo);
        redirectAttributes.addFlashAttribute(AppConstants.PageAttributes.ORDER, order);
    ...
    public String handleOutOfStockException(RedirectAttributes redirectAttributes) {
